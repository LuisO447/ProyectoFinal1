...
public class Variables {
    ...
    String name;
    String forme_name;
    String forme_base_pokemon_id;
    String generation_id;
    String evolution_chain_id;
    String evolution_parent_pokemon_id;
    String evolution_method_id;
    String evolution_parameter;
    String height;
    String weight;
    String species;
    String color;
    String pokemon_shape_id;
    String habitat;
    String gender_rate;
    String capture_rate;
    String base_experience;
    String base_happiness;
    String gen1_internal_id;
    String is_baby;
    String has_gen4_fem_sprite;
    String has_gen4_fem_back_sprite;

    public Variables(String id, String name, String forme_name, String forme_base_pokemon_id, String generation_id, String evolution_chain_id, String evolution_parent_pokemon_id, String evolution_method_id, String evolution_parameter, String height, String weight, String species, String color, String pokemon_shape_id, String habitat, String gender_rate, String capture_rate, String base_experience, String base_happiness, String gen1_internal_id, String is_baby, String has_gen4_fem_sprite, String has_gen4_fem_back_sprite) {
        this.id = id;
        this.name = name;
